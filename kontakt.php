...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <meta content="Målare Täby | Målning , Tapetsering , Fasadmålning" property="og:title"/>
    <meta content="website" property="og:type"/>
    <meta content="images/taby.jpg" property="og:image"/>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <button aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"
                ...
                type="button">
            <i aria-hidden="true" class="fa fa-bars" style="color: darkblue; font-size: 30px"></i>
        </button>
            ...
            <ul class="navbar-nav ml-auto font-weight-bold">
                ...
                <li class="nav-item dropdown">
                    <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle"
                       ...
                       href="#" id="navbarDropdownPortfolio" style="color: #0d178c!important;">
                        VÅRA TJÄNSTER
                    </a>
...
<div class=" container-fluid footer main">
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-7 col-sm-12 col-12">
            <h2 class="title">Varmt välkommen att kontakta oss!</h2>
            <p>
                Tack för ditt intresse av våra tjänster. Vi kommer att svara på din förfrågan så snart som möjligt.
                Vi ber dig notera att alla fält som är märkta med en asterisk
                <i aria-hidden="true" class="fa fa-asterisk"></i>&#160; måste fyllas i, så att vi bättre kan hjälpa
                dig.
            </p>
            <form action="contact.php" method="post">
                <div class="form-group">
                    <label><i aria-hidden="true" class="fa fa-user"></i>- Ditt namn
                        <i aria-hidden="true" class="fa fa-asterisk"></i></label>
                    <input class="form-control" id="name" name="name" placeholder="Fyll i ditt namn" type="text">
                </div>
                <div class="form-group">
                    <label><i aria-hidden="true" class="fa fa-envelope-o"></i>- Din epost</label>
                    <i aria-hidden="true" class="fa fa-asterisk"></i>
                    <input class="form-control" id="email" name="email" placeholder="Fyll i epost" type="email">
                </div>
                <div class="form-group">
                    <label><i aria-hidden="true" class="fa fa-header"></i>- Ämne</label>
                    <i aria-hidden="true" class="fa fa-asterisk"></i>
                    <input class="form-control" id="subject" name="subject" placeholder="Fyll i ämne" type="text">
                </div>
                <div class="form-group">
                    <label><i aria-hidden="true" class="fa fa-comment-o"></i>- Ditt meddelande</label>
                    <i aria-hidden="true" class="fa fa-asterisk"></i>
                    <textarea class="form-control" id="message" name="meassage_text"></textarea>
                </div>
                <div class="form-group">
                    <button id="submit_kontakt" name="submit_kontakt" onclick="isEmpty()" type="submit" value="Skicka">
                        Skicka
                    </button>
                </div>
            </form>
